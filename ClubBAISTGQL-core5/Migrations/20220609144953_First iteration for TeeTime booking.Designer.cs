...
namespace ClubBAISTGQL.Migrations
{
    ...
    [Migration("20220609144953_First iteration for TeeTime booking")]
    partial class FirstiterationforTeeTimebooking
    {
            ...
            modelBuilder.Entity("ClubBAISTGQL.Models.Membership", b =>
                {
                    ...
                    b.Property<TimeSpan>("RestrictedPlayingTimeEnd")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("RestrictedPlayingTimeStart")
                        .HasColumnType("time");
